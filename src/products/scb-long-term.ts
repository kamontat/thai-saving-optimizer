...
const baseMetadata = {
	...
	interestCalculation: "คำนวณดอกเบี้ยจากยอดคงเหลือประจำวัน ทบดอกเบี้ยเป็นเงินต้นทุก 6 เดือน",
	insuranceNote:
		"เงินฝากนี้ได้รับการคุ้มครองจากสถาบันคุ้มครองเงินฝากตามจำนวนที่กำหนดไว้",
