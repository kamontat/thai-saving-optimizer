...
const baseMetadata = {
	...
	interestCalculation:
		"คำนวณดอกเบี้ยตามอัตราที่กำหนดในแต่ละช่วง แบบขั้นบันได (step-up)",
...
export const ttbUpAndUp12m: FixedDepositProduct = {
	...
	tags: ["digital"],
	description:
		"ฝากประจำดอกเบี้ยขั้นบันได 12 เดือน ดอกเบี้ยเพิ่มทุก 3 เดือน เฉลี่ย 0.75% ต่อปี",
...
export const ttbUpAndUp24m: FixedDepositProduct = {
	...
	tags: ["digital"],
	description:
		"ฝากประจำดอกเบี้ยขั้นบันได 24 เดือน ดอกเบี้ยเพิ่มทุก 6 เดือน เฉลี่ย 0.90% ต่อปี",
	conditions: baseConditions,
	metadata: {
		...baseMetadata,
